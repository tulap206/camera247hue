...
export const SAMPLE_LOGS: AccessLog[] = [
  ...
  },
  {
    ...
    details: 'Khách hàng xem công trình: Lắp đặt hệ thống 32 Camera an ninh Khách sạn Hương Giang',
...
const LOCAL_STORAGE_KEY_CUSTOMERS = 'c247_customers_v3'
const LOCAL_STORAGE_KEY_ORDERS = 'c247_orders_v3'
const LOCAL_STORAGE_KEY_LOGS = 'c247_logs_v3'
